        ...
        >
          <div
            className={`profile__info ${
              isEditActive && "profile__info_active"
            }`}
          >
            <label className="profile__key" htmlFor="user__name">
              Имя
            </label>
            {isEditActive ? (
              <input
                className={`profile__value ${
                  isEditActive && "profile__value_active"
                }`}
                type="text"
                id="user__name"
                name="name"
          ...
          <span className="profile__error" id="user__name-error">
            {errors.name || ""}
          </span>
          <div className="profile__info">
            <label className="profile__key" htmlFor="user__email">
              Email
            </label>
            {isEditActive ? (
              <input
          ...
          <span className="profile__error" id="user__email-error">
            {errors.email || ""}
          </span>
        </form>
        {isEditActive ? (
